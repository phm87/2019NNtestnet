...
use crate::utxo::rpc_clients::{ElectrumRpcRequest, NativeClientImpl, UtxoRpcClientOps, LndClientImpl};
...
impl LnCoin {
    ...
    fn validate_payment(
        ...
        let tx: LnTx = try_fus!(deserialize(payment_tx).map_err(|e| ERRL!("{:?}", e)));
...
pub async fn ln_coin_from_conf_and_request(
    ctx: &MmArc,
    ticker: &str,
    conf: &Json,
    req: &Json,
