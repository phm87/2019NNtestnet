...
struct dpow_block
{
    ...
    int32_t pendingprevDESTHT,rawratifiedlens[2],height,numnotaries,numerrors,completed,minsigs,duration,numratified,isratify,require0,scores[DPOW_MAXRELAYS],destht_start;
